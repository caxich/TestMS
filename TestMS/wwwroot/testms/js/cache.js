...
layui.use(['form','jquery',"layer"],function() {
    ...
    if (window.sessionStorage.getItem('userFace') && $(".userAvatar").length > 0) {
        ...
        $("#userFace").attr("src","~/testms/image/face.jpg");
    }
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="~/testms/image/face.jpg" class="userAvatar"/></div>'+
                            '<div class="admin-header-lock-name" id="lockUserName">CXC</div>'+
                            '<div class="input_btn">'+
